...
public class DeliveredOrderFragment extends Fragment implements DatePicker.selectedDate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        selectDateTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("kkk","Fragment List Select:"+getFragmentManager().getFragments().toString());
